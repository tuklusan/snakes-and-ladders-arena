...
async function runChecks() {
  // Create a jsdom with mocked animation frame functions
  const dom = await JSDOM.fromFile('index.html', {
    runScripts: "dangerously",
    resources: "usable",
    beforeParse(window) {
      // Mock the animation frame functions
  ...
  window.console.error = (...args) => { console.error('[window.console.error]', ...args); };
  window.console.log = (...args) => { console.log('[window.console.log]', ...args); };
  ...
  // Check if global constructors exist
  console.log('GameModel:', typeof window.GameModel);
  console.log('GameView:', typeof window.GameView);
  console.log('GameController:', typeof window.GameController);

  // Check if main.js has run by looking for exposed properties
  console.log('window.gameModel:', window.gameModel);
  console.log('window.gameController:', window.gameController);
  console.log('window.gameView:', window.gameView);

  // Debug: check if board element exists now
  const boardElement = document.getElementById('game-board');
  console.log('Board element after init:', boardElement);
  if (boardElement) {
    console.log('Board element children count:', boardElement.children.length);
    console.log('Board element innerHTML length:', boardElement.innerHTML.length);
  }
