...
async function runChecks() {
  ...
  console.log('gameBoardContainer:', gameBoardContainer);
  if (gameBoardContainer) {
    console.log('gameBoardContainer innerHTML:', gameBoardContainer.innerHTML);
  }

  // Check if game-board exists
  const gameBoard = d.getElementById('game-board');
  console.log('game-board:', gameBoard);
  if (gameBoard) {
    console.log('game-board innerHTML:', gameBoard.innerHTML);
