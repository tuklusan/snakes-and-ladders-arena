...
async function runChecks() {
  ...
  const gameModel = fs.readFileSync('src/js/gameModel.js', 'utf8');
  const gameController = fs.readFileSync('src/js/gameController.js', 'utf8');
  const gameView = fs.readFileSync('src/js/gameView.js', 'utf8');
  ...
  try {
    ...
    console.error('Error evaluating gameModel.js:', e);
  }
  try {
    eval(gameController);
    console.log('GameController defined:', typeof window.GameController);
  } catch (e) {
    console.error('Error evaluating gameController.js:', e);
  }
  try {
    eval(gameView);
    console.log('GameView defined:', typeof window.GameView);
  } catch (e) {
    console.error('Error evaluating gameView.js:', e);
  }
  try {
    eval(main);
  ...
  // Now create the actual HTML structure
  ...
  // Check if global constructors exist in window2
  console.log('In window2:');
  console.log('GameModel:', typeof window2.GameModel);
  console.log('GameView:', typeof window2.GameView);
  console.log('GameController:', typeof window2.GameController);

  // Check if main.js has run by looking for exposed properties
  console.log('window2.gameModel:', window2.gameModel);
  console.log('window2.gameController:', window2.gameController);
  console.log('window2.gameView:', window2.gameView);
