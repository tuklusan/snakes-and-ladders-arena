...
async function runChecks() {
  ...
  // We'll now run the checks as defined in the run() function of diag_accept.html
  // But we need to adjust for the fact that we are not in an iframe.
  // The original function uses:
  //   const fr=document.getElementById("f"),d=fr.contentDocument,w=fr.contentWindow;
  // We'll set d and w to the current document and window.
